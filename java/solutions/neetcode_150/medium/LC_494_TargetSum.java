 ...
 */
public class LC_494_TargetSum implements Solution {
    ...
    public void run() {
        ...
        System.out.println("Testing LC_494_TargetSum:");
        System.out.println("Input: nums = " + java.util.Arrays.toString(nums) + ", target = " + target);
        
        int result1 = findTargetSumWays(nums, target);
        System.out.println("Optimized DP Solution: " + result1);
        
        int result2 = findTargetSumWaysDFS(nums, target);
        System.out.println("DFS Solution: " + result2);
        
        int result3 = findTargetSumWaysMapDP(nums, target);
        System.out.println("Map DP Solution: " + result3);
    }
}